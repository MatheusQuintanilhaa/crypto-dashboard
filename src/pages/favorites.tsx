              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    {favorites.length}{" "}
                    {favorites.length === 1
                      ? "criptomoeda favoritada"
                      : "criptomoedas favoritadas"}
                  </p>
                </div>
              </div>
        ...
        {favorites.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 space-y-6">
            ...
            <div className="text-center">
              ...
              >
                Adicione suas criptomoedas favoritas para acompanhá-las
                facilmente e ter acesso rápido às informações mais importantes.
              </p>
            </div>
            <Link to="/">
