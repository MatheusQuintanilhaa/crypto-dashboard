    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100">
        <div className="container mx-auto px-4 py-8">
          <Button variant="ghost" onClick={() => navigate(-1)} className="mb-6 text-slate-600 hover:text-slate-800">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <Card key={i} className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md">
                  <CardHeader>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2">
            <Button variant="ghost" onClick={() => navigate(-1)} className="text-slate-600 hover:text-slate-800 p-2">
              <ArrowLeft className="h-5 w-5" />
              <span className="sr-only">Voltar</span>
            </Button>
            <h2 className="text-lg font-medium text-slate-600">Detalhes da Moeda</h2>
          </div>
                ...
                <div className="flex items-center gap-4">
                  {!imageError ? (
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-white to-blue-50 border-blue-200/30 rounded-full flex items-center justify-center">
                      <span className="text-2xl font-bold text-slate-800">{coin.symbol.charAt(0).toUpperCase()}</span>
                    </div>
                  )}
                  <div>
                    <div className="flex items-center gap-2">
                      <h1 className="text-3xl md:text-4xl font-bold text-slate-800">{coin.name}</h1>
                      <Badge variant="outline" className="text-xs font-medium uppercase border-blue-200/50 bg-gradient-to-br from-white to-blue-50">
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-sm text-slate-600">Market Cap</CardTitle>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                  ...
                  <CardContent>
                    <p className="text-xl font-bold text-slate-800">{formatLargeNumber(coin.market_data.market_cap.usd)}</p>
                    <div
                      className={`flex items-center mt-1 text-sm ${
                        coin.market_data.market_cap_change_percentage_24h > 0 ? "text-green-600" : "text-red-600"
                      }`}
                    >
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-sm text-slate-600">Volume 24h</CardTitle>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Info className="h-4 w-4 text-slate-500" />
                  ...
                  <CardContent>
                    <p className="text-xl font-bold text-slate-800">{formatLargeNumber(coin.market_data.total_volume.usd)}</p>
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-sm text-slate-600">Circulating Supply</CardTitle>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Info className="h-4 w-4 text-slate-500" />
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm text-slate-600">All Time High</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <p className="text-xl font-bold text-slate-800">{formatPrice(coin.market_data.ath.usd)}</p>
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm text-slate-600">All Time Low</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <p className="text-xl font-bold text-slate-800">{formatPrice(coin.market_data.atl.usd)}</p>
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md backdrop-blur-sm hover:bg-gradient-to-br hover:from-white hover:to-blue-100">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm text-slate-600">Variação de Preço</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={
                            coin.market_data.price_change_percentage_7d > 0 ? "text-green-600" : "text-red-600"
                          }
                        >
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={
                            coin.market_data.price_change_percentage_30d > 0 ? "text-green-600" : "text-red-600"
                          }
                        >
            ...
            <TabsContent value="markets" className="space-y-6">
              <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md">
                <CardHeader>
                  <CardTitle className="text-slate-800">Informações de Mercado</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-slate-600 mb-1">24h High</p>
                      <p className="text-lg font-semibold text-slate-800">{formatPrice(coin.market_data.high_24h.usd)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600 mb-1">24h Low</p>
                      <p className="text-lg font-semibold text-slate-800">{formatPrice(coin.market_data.low_24h.usd)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600 mb-1">Market Cap Rank</p>
                      <p className="text-lg font-semibold text-slate-800">#{coin.market_cap_rank}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600 mb-1">Price Change (24h)</p>
            ...
            <TabsContent value="about" className="space-y-6">
              <Card className="bg-gradient-to-br from-white to-blue-50 border-blue-200/30 shadow-md">
                <CardHeader>
                  <CardTitle className="text-slate-800">Sobre {coin.name}</CardTitle>
                </CardHeader>
                <CardContent>
